    ...
    return (
        <div style={{ border: '1px solid #eee', borderRadius: 8, padding: 24, marginBottom: 24, background: '#fafbfc' }}>
            ...
            <div style={{ marginBottom: 8, color: '#888', fontSize: 13 }}>
                Select the ASN.1 specification (enter manually, upload new, or pick existing). Compile to check the syntax and to extract the data Types to be used in Decoding and Encoding.</div>
            <TextArea
                rows={8}
                value={asnText}
