...
const SpecificationBox = () => {
    ...
    const [asnText, setAsnText] = useState(`--<ASN1.HugeInteger World-Schema.Rocket.range>--
...
END`);
    ...
    return (
        <div style={{ border: '1px solid #eee', borderRadius: 8, padding: 24, marginBottom: 24, background: '#fafbfc' }}>
            ...
            <Button type="dashed" style={{ marginTop: 16, float: 'right' }}>Reset</Button>
            <Divider />
            <div style={{ marginBottom: 8 }}>Compile Options</div>
